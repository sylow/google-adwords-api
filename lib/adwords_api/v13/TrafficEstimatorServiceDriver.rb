  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V13::TrafficEstimatorService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/v13", :use=>"literal", :encodingstyle=>"document", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "estimateAdGroupList",
