  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V200909::CampaignCriterionService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/cm/v200909", :use=>"literal", :encodingstyle=>"document", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
