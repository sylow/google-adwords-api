  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201003::AdExtensionOverrideService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/cm/v201003", :use=>"literal", :encodingstyle=>"document", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
