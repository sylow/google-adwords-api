  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201003::InfoService::ApiException_"=>{:ns=>"https://adwords.google.com/api/adwords/info/v201003", :use=>"literal", :encodingstyle=>"document", :name=>"ApiException", :namespace=>nil}} }
    ]
  ]
