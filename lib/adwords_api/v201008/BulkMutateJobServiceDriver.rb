  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201008::BulkMutateJobService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/cm/v201008", :use=>"literal", :encodingstyle=>"document", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
